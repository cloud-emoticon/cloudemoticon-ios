...
//        self.view.addSubview(bgpview)
        ...
        NSNotificationCenter.defaultCenter().addObserver(self, selector: #selector(SetTableViewController.切换主题), name: "切换主题通知", object: nil)
        NSNotificationCenter.defaultCenter().addObserver(self, selector: #selector(SetTableViewController.屏幕旋转(_:)), name: "屏幕旋转通知", object: nil)
        切换主题()
    }
